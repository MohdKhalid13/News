        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form className="d-flex" role="search">
              <input className={`form-control me-2 text-${props.mode == "dark" ? "dark" : "light"} bg-${props.mode == "dark" ? "light" : "dark"}`} type="search" id='search' placeholder="Enter The Querie" autoComplete='off'  aria-label="Search" />
